 ...
 */
final class Version20191110104222 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE quiz (id INT NOT NULL, chat_id INT DEFAULT NULL, current_step_id INT DEFAULT NULL, length INT NOT NULL, is_complete BOOLEAN NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE quiz ADD CONSTRAINT FK_A412FA92D9BF9B19 FOREIGN KEY (current_step_id) REFERENCES quiz_steps (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
